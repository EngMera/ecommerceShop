        ...
        <div class="col-md-12">
            ...
            <div class="card">
                <div class="card-header d-flex justify-content-between ">
                    <h3>Category</h3>
                    <a href="{{ url('admin/category/create') }}" class="btn btn-primary btn-sm text-white ">Add Category</a>
                </div>
                <div class="card-body">
                    <table class="table table-bordered table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{ url('admin/category/'.$category->id.'/edit') }}" class="btn btn-primary text-white">Edit</a>
