                                    ...
                                    <div class="col-md-6 my-auto">
                                        <a href="<?php echo e(url('/collections/'.$wishlistItem->product->category->slug.'/'.$wishlistItem->product->slug)); ?>">
                                            <label class="product-name">
                                                <img src="<?php echo e($wishlistItem->product->productImage[0]->image); ?>" style="width: 50px; height: 50px" alt="<?php echo e($wishlistItem->product->name); ?>">
...
<?php /**PATH C:\xampp\htdocs\quality\resources\views/livewire/frontend/wishlist-show.blade.php ENDPATH**/ ?>