...
<?php $__env->startSection('title','New Arrivals'); ?>
            ...
            <div class="py-5 ">
                <div class="container">
                    <div class="row ">
                        ...
                        <?php $__empty_1 = true; $__currentLoopData = $newArrivalsProducts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $productItem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <div class="col-md-3">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\quality\resources\views/frontend/pages/new-arrivals.blade.php ENDPATH**/ ?>