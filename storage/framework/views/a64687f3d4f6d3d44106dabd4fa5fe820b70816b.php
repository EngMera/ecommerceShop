    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header d-flex justify-content-between ">
                <h3>Edit Category</h3>
                <a href="<?php echo e(url('admin/category')); ?>" class="btn btn-primary btn-sm text-white ">BACK</a>
            </div>
            <div class="card-body">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <textarea type="text" name="description"  class="form-control" rows="3"><?php echo e($category->description); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="row ">
                        <div class="col-md-6 mb-3">
                            ...
                            <img src="<?php echo e(asset('/uploads/category/'.$category->image )); ?> " width="60px" height="60px" alt="pic">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-md-12 mb-3">
                        ...
                        <textarea type="text" name="meta_description"  class="form-control" rows="3"><?php echo e($category->meta_description); ?></textarea>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\quality\resources\views/admin/category/edit.blade.php ENDPATH**/ ?>