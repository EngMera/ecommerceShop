<div>
    <div class="footer-area">
        <div class="container">
            <div class="row">
                <div class="col-md-3">
                    <h4 class="footer-heading">{{ $appSetting->name ?? 'Website Name' }}</h4>
                ...
                <div class="col-md-3">
                    ...
                    <div class="mb-2"><a href="{{ url('/home') }}" class="text-white">Trending Products</a></div>
                ...
                <div class="col-md-3">
                    ...
                    <div class="mb-2">
                        <p>
                            <i class="fa fa-map-marker"></i> {{ $appSetting->address ?? 'Website adress' }}
                        </p>
                    </div>
                    <div class="mb-2">
